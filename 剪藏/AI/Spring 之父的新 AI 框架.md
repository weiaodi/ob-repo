...
created: 2026-08-05
updated: 2026-08-14
source: "https://juejin.cn/post/7668305038255521838"
author:
  - [[苏三说技术]]
published: 2026-08-01
description: 前言 最近这阵子，技术圈里有一个名字频繁出现在各种讨论中——Rod Johnson。 如果你不知道他是谁，那你一定知道他做的东西——Spring Framework。 没错，就是那个几乎重新定义了企业
---
...
![image](https://p6-xtjj-sign.byteimg.com/tos-cn-i-73owjymdk6/3ae5cfb2f7d74812a27ab645a9dc24f7~tplv-73owjymdk6-jj-mark-v1:0:0:0:0:5o6Y6YeR5oqA5pyv56S-5Yy6IEAg6IuP5LiJ6K-05oqA5pyv:q75.awebp?rk3s=f64ab15b&x-expires=1786182236&x-signature=AmhIlGdQl7aO9NlLKFQFZA9P5iE%3D)
...
![image](https://p6-xtjj-sign.byteimg.com/tos-cn-i-73owjymdk6/ad07eb61c4084387ba50f29de7ba4d8c~tplv-73owjymdk6-jj-mark-v1:0:0:0:0:5o6Y6YeR5oqA5pyv56S-5Yy6IEAg6IuP5LiJ6K-05oqA5pyv:q75.awebp?rk3s=f64ab15b&x-expires=1786182236&x-signature=16yCExYr4eEsM5xmq3wmbFOvIno%3D)

GOAP规划流程详解：

![image](https://p6-xtjj-sign.byteimg.com/tos-cn-i-73owjymdk6/339c855a84d446fea39838ab1bff77aa~tplv-73owjymdk6-jj-mark-v1:0:0:0:0:5o6Y6YeR5oqA5pyv56S-5Yy6IEAg6IuP5LiJ6K-05oqA5pyv:q75.awebp?rk3s=f64ab15b&x-expires=1786182236&x-signature=a7jlFFGE8Oks4%2BLR%2F0zAyhhqY9w%3D)
...
```bash
代码解读复制代码// 定义一个Action——纯粹的Java代码，没有字符串拼接
...
```bash
代码解读复制代码// Embabel中，Action的输入输出都是强类型领域对象
...
```bash
代码解读复制代码import com.embabel.agent.api.annotation.Action;
...
```bash
代码解读复制代码import com.embabel.agent.api.Agent
